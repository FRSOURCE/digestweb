---
layout: article
title: 'Vite 8.0 Ships with Rolldown, Wasm SSR, & Major Performance Boosts'
description: 'Vite 8.0, a "mega release," introduces Rolldown as a replacement for Rollup/esbuild, adds WebAssembly SSR support, and delivers substantial performance improvements, marking a significant evolution for the popular build tool.'
photo: https://picsum.photos/id/523/800/450
original_url: https://javascriptweekly.com/issues/777
source_name: 'JavaScript Weekly'
source_author: ''
tags: [build-tools, tooling, javascript, web-platform]
significance: 4
---
...
*   **Babel-Free React Plugin:** `@vitejs/plugin-react` v6 no longer requires Babel.
*   **Temporal API Advances:** The long-awaited Temporal API for robust date/time handling in JavaScript continues to gain support and advance through TC39.
