---
layout: article
title: 'Chrome 147 Boosts View Transitions with Concurrent & Nested Scopes'
description: 'Chrome 147 introduces element-scoped view transitions, allowing developers to create concurrent and nested animations for more sophisticated and performant UI experiences.'
photo: 'https://developer.chrome.com/static/blog/element-scoped-view-transitions/image/element-scoped-view-transitions.png'
original_url: https://developer.chrome.com/blog/element-scoped-view-transitions?hl=en
