---
layout: article
title: "JavaScript in 2026: Google's JSIR, JetStream 3, and Ecosystem Overview"
description: "This JavaScript Weekly issue highlights Google's new JSIR for advanced tooling, the release of browser performance benchmark JetStream 3, and provides a comprehensive overview of the current JavaScript ecosystem."
photo: 'https://picsum.photos/id/185/800/450'
original_url: https://javascriptweekly.com/issues/780
source_name: 'JavaScript Weekly'
source_author: ''
tags: [javascript, web-platform, tooling, release]
significance: 3
---
...
- ESLint v10.2.0 adds support for language-aware rules, and Node.js 25.9.0 introduces `--max-heap-size` and an experimental iterable streams API.
