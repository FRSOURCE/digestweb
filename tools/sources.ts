...
export const sources: Source[] = [
  ...
  },
  {
    ...
    name: 'Ahmad Shadeed',
    category: 'person-blog',
    tags: ['css', 'design', 'web-platform'],
    feed: 'https://ishadeed.com/feed.xml',
    homeUrl: 'https://ishadeed.com',
  ...
  },
  {
    ...
    name: 'Stefan Judis',
    category: 'person-blog',
    tags: ['javascript', 'web-platform', 'dx'],
    feed: 'https://www.stefanjudis.com/rss.xml',
    homeUrl: 'https://www.stefanjudis.com',
    authorName: 'Stefan Judis',
  },
  {
    id: 'alex-russell',
    name: 'Infrequently Noted (Alex Russell)',
    category: 'person-blog',
    tags: ['browser', 'web-platform', 'performance'],
    feed: 'https://infrequently.org/feed/',
    homeUrl: 'https://infrequently.org',
  ...
  },
  {
    ...
    category: 'person-blog',
    tags: ['css', 'design', 'web-platform'],
    feed: 'https://robinrendle.com/feed.xml',
    homeUrl: 'https://robinrendle.com',
  ...
  },
  {
    ...
    name: 'Codrops',
    category: 'general',
    tags: ['css', 'javascript', 'tutorial', 'design'],
    feed: 'https://tympanus.net/codrops/feed/',
    homeUrl: 'https://tympanus.net/codrops',
  },
  {
    id: 'una-kravets',
    name: 'Una Kravets',
  ...
  },
  {
    ...
    category: 'ai',
    tags: ['ai', 'research'],
    feed: 'https://www.microsoft.com/en-us/research/blog/feed/',
